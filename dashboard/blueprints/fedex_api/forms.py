...
class CreateShipmentForm(Form):
    ...
    commodities_quantity = IntegerField('Quantity')
    ...
    r_shipment_purpose = SelectField('Shipment Purpose', choices=choices.sh_purpose_choices, default='GIFT')
    # ============ END Package details

    # ============ Billing
    # payload['requestedShipment']['shippingChargesPayment']['paymentType']
    r_shipment_shippingChargesPayment = SelectField('Transportation coast', choices=choices.paymentType, default='SENDER')
